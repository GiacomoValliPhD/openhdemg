...
class MuAnalysis:
    ...
    def __init__(self, parent):
        ...
        # MVC Entry
        ctk.CTkLabel(
            self.head, text="Enter MVC[n]:", font=('Segoe UI', 15, 'bold'),
        ).grid(column=0, row=0, sticky=(W))
        self.mvc_value = StringVar()
        enter_mvc = ctk.CTkEntry(
            self.head, width=100, textvariable=self.mvc_value,
        )
        ...
        thresh = ctk.CTkButton(
            self.head, text="Compute threshold",
            command=self.compute_mu_threshold, fg_color="#E5E4E2",
        ...
        ct_events_entry = ctk.CTkComboBox(
            self.head, width=100, variable=self.ct_event,
        ...
        ct_types_entry = ctk.CTkComboBox(
            self.head, width=100, variable=self.ct_type,
        ...
        separator1.grid(
            column=0, columnspan=4, row=4, sticky=(W, E), padx=5, pady=5,
        )

        ctk.CTkLabel(
            self.head, text="Firings at Rec", font=('Segoe UI', 15, 'bold'),
        ).grid(column=1, row=5, sticky=(W, E))
        ctk.CTkLabel(
            self.head, text="Firings Start/End Steady",
            font=('Segoe UI', 15, 'bold'),
        ).grid(column=2, row=5, sticky=(W, E))

        dr_rate = ctk.CTkButton(
            self.head, text="Compute discharge rate",
            command=self.compute_mu_dr, fg_color="#E5E4E2", text_color="black",
        ...
        firings_1 = ctk.CTkEntry(
            self.head, width=100, textvariable=self.firings_rec,
        )
        ...
        firings_2 = ctk.CTkEntry(
            self.head, width=100, textvariable=self.firings_ste,
        )
        ...
        dr_events_entry = ctk.CTkComboBox(
            self.head, width=100, variable=self.dr_event,
        ...
        separator2.grid(
            column=0, columnspan=4, row=7, sticky=(W, E), padx=5, pady=5,
        )

        ctk.CTkLabel(
            self.head, text="Firings at Rec",
            font=('Segoe UI', 15, 'bold'),
        ...
        basic = ctk.CTkButton(
            self.head, text="Basic MU properties",
            command=self.basic_mus_properties, fg_color="#E5E4E2",
            text_color="black", border_color="black", border_width=1,
        )
        ...
        b_firings_1 = ctk.CTkEntry(
            self.head, width=100, textvariable=self.b_firings_rec,
        )
        ...
        b_firings_2 = ctk.CTkEntry(
            self.head, width=100, textvariable=self.b_firings_ste,
        )
    ...
    def basic_mus_properties(self):
        ...
        try:
            ...
            show_error_dialog(
                parent=self, error=e,
                solution=str("Select start/end area again."))
