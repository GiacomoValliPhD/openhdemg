...
def plot_muap(
    ...
    In this case we are plotting the matrix channel 45 which is placed in column 4
    ("col3") as Python numbering is base 0.
    ...
    It is also possible to vosualise the spyke triggered average
