...
def emg_from_DEMUSE (file):
    ...
    return SOURCE, RAW_SIGNAL, REF_SIGNAL, PNR, IPTS, MUPULSES, FSAMP, IED, EMG_LENGTH, NUMBER_OF_MUS, BINARY_MUS_FIRING
...
# The user can decide if he wonts the filtered or unfiltered reference signal
...
def get_OTB_rawsignal(df):
    ...
    if len(emg_df.columns) == expectedchannels:
        ...
        print("ERROR in searching the raw signal, please check it")
